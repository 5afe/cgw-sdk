 ...
 */
import type { paths, operations } from "./schema.ts";
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["About"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["CreateAccountDto"];
        };
      };
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Account"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["AccountDataType"][];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["AccountDataSetting"][];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["CounterfactualSafe"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Balances"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["ChainPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Chain"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["AboutChain"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Backbone"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["MasterCopy"][];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["CollectiblePage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["CampaignPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Campaign"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["CampaignRankPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["CampaignRank"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["LockingRankPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["LockingRank"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["LockingEventPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Contract"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["TransactionDataDto"];
        };
      };
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["DataDecoded"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["DelegatePage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["DeleteDelegateDto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["DeleteSafeDelegateDto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["DeleteDelegateV2Dto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["AddRecoveryModuleDto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["GetEstimationDto"];
        };
      };
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["EstimationResponse"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Message"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["MessagePage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["UpdateMessageSignatureDto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["RegisterDeviceDto"];
        };
      };
      responses: {
        200: {
    ...
    },
    {
      ...
      body: {
        ...
        safeRegistrations: import("./schema.ts").components["schemas"]["SafeRegistration"][];
      };
    },
    `${string}/${string}`
  >
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["SafeList"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["RelayDto"];
        };
      };
      responses: {
        201: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["SafeApp"][];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["SafeState"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["SafeNonces"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["TransactionDetails"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["MultisigTransactionPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["DeleteTransactionDto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["ModuleTransactionPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["AddConfirmationDto"];
        };
      };
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["Transaction"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["IncomingTransferPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["PreviewTransactionDto"];
        };
      };
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["TransactionPreview"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["QueuedItemPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json": import("./schema.ts").components["schemas"]["TransactionItemPage"];
          };
        };
      };
    },
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      requestBody: {
        content: {
          "application/json": import("./schema.ts").components["schemas"]["ProposeTransactionDto"];
        };
      };
      responses: {
        200: {
  ...
  import("openapi-fetch").FetchResponse<
    {
      ...
      responses: {
        200: {
          ...
          content: {
            "application/json":
              | import("./schema.ts").components["schemas"]["BaselineConfirmationView"]
              | import("./schema.ts").components["schemas"]["CowSwapConfirmationView"];
          };
        };
      };
    },
