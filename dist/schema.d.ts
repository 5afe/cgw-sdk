...
export type BlockExplorerUriTemplate =
  components["schemas"]["BlockExplorerUriTemplate"];
...
export type DataDecodedParameter =
  components["schemas"]["DataDecodedParameter"];
...
export type UpdateMessageSignatureDto =
  components["schemas"]["UpdateMessageSignatureDto"];
...
export type SafeAppAccessControl =
  components["schemas"]["SafeAppAccessControl"];
export type SafeAppSocialProfile =
  components["schemas"]["SafeAppSocialProfile"];
...
export type IncomingTransferPage =
  components["schemas"]["IncomingTransferPage"];
export type PreviewTransactionDto =
  components["schemas"]["PreviewTransactionDto"];
